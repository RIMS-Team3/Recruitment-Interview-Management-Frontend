...
import { toast, ToastContainer } from 'react-toastify'; // Thêm mới
import Swal from 'sweetalert2'; // Thêm mới
...
toast.error("Không thể tải danh sách tin tuyển dụng!"); // Thay alert bằng toast.error
}
};
...
return toast.warning("Lương tối thiểu không được lớn hơn lương tối đa!"); // Thay alert bằng toast.warning
}
...
return toast.warning("Hạn nộp phải là một ngày trong tương lai!"); // Thay alert bằng toast.warning
}
...
toast.success("Cập nhật tin tuyển dụng thành công!"); // Thay alert bằng toast.success
} else {
await api.post('/CRUDJobPost/create', payload);
toast.success("Tạo tin tuyển dụng mới thành công!"); // Thay alert bằng toast.success
setCurrentPage(1); 
}
...
toast.error(typeof serverError === 'string' ? serverError : "Có lỗi xảy ra, vui lòng thử lại!"); // Thay alert bằng toast.error
}
};
...
confirmButtonColor: '#16a34a', // Màu xanh thương hiệu của bạn
cancelButtonColor: '#ef4444',
confirmButtonText: 'Đồng ý xóa',
cancelButtonText: 'Hủy bỏ',
customClass: {
confirmButton: 'swal-btn-soft', // Thêm class để bo góc mềm mại hơn
...
toast.success("Đã xóa tin tuyển dụng thành công!"); // Thay alert bằng toast.success
fetchJobs();
} catch (err) { 
toast.error("Lỗi khi xóa tin tuyển dụng!"); // Thay alert bằng toast.error
}
}
});
};
...
{/* Container hiển thị các thông báo Toast */}
